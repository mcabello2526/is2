...
public class GUIGenero extends JFrame implements IGUI {
	...
	//private Color btnVerde = new Color(134, 231, 120);
 	...
 	public GUIGenero() {
		...
		contentPane.add(getBtnMostrarPorPelicula());
	...
	private JButton getBtnCrear() {
		if (btnCrear == null) {
			btnCrear = new JButton("Añadir género");
			...
			btnCrear.addActionListener(new ActionListener() {
               @Override
                public void actionPerformed(ActionEvent e) {
                    Controlador.getInstance().accion(Evento.GUI_CREAR_GENERO,null );
                }
            });
		}
		return btnCrear;
	...
	private JButton getBtnEliminar() {
		if (btnEliminar == null) {
			...
			btnEliminar.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					Controlador.getInstance().accion(Evento.GUI_ELIMINAR_GENERO,null );
				}
			});
		}
		return btnEliminar;
	...
	private JButton getBtnModificar() {
		if (btnModificar == null) {
			btnModificar = new JButton("Modificar género");
			...
			btnModificar.addActionListener(new ActionListener() {
                @Override
                public void actionPerformed(ActionEvent e) {
                	Controlador.getInstance().accion(Evento.GUI_MODIFICAR_GENERO,null );
                }
            });
		}
		return btnModificar;
	...
	private JButton getBtnMostrar() {
		if (btnMostrar == null) {
			btnMostrar = new JButton("Mostrar género");
			...
			btnMostrar.addActionListener(new ActionListener() {
                @Override
                public void actionPerformed(ActionEvent e) {
                	Controlador.getInstance().accion(Evento.GUI_MOSTRAR_GENERO,null );
                }
            });
		}
		return btnMostrar;
	...
	private JButton getBtnMostrarPorPelicula() {
		if (btnMostrarPorPelicula == null) {
			btnMostrarPorPelicula = new JButton("Mostrar géneros por película");
			btnMostrarPorPelicula.setFont(new Font("Tahoma", Font.BOLD, 14));
			btnMostrarPorPelicula.setBackground(botones);
			btnMostrarPorPelicula.setForeground(textoBlanco);
			btnMostrarPorPelicula.setBounds(100, 250, 300, 35);
			btnMostrarPorPelicula.addActionListener(new ActionListener() {
                @Override
                public void actionPerformed(ActionEvent e) {
                	Controlador.getInstance().accion(Evento.GUI_MOSTRAR_GENEROS_POR_PELICULA,null );
                }
            });
		}
		return btnMostrarPorPelicula;
	}
	...
	private JButton getBtnMostrarTodos() {
		if (btnMostrarTodos == null) {
			...
			btnMostrarTodos.addActionListener(new ActionListener() {
                @Override
                public void actionPerformed(ActionEvent e) {
                	Controlador.getInstance().accion(Evento.GUI_MOSTRAR_TODOS_LOS_GENEROS,null );
                }
            });
		}
