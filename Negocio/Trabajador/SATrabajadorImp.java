...
public class SATrabajadorImp implements SATrabajador {
	...
	public int crear(TTrabajador tTrabajador) {
	    List<TTrabajador> trabajadores = FactoryDAO.getInstance().getDAOTrabajador().mostrarTodos();
	    int id = -1; 
    ...
    public List<TTrabajador> mostrarTodos() {
		List<TTrabajador> todos = FactoryDAO.getInstance().getDAOTrabajador().mostrarTodos();
